                    ...
                    <div className="w-full md:col-span-7 ">
                        <div>
                            <form
                                ...
                                className="overflow-hidden border-2 border-primary-600 bg-primary-600 flex rounded-lg shadow-sm"
                            >
                                <input
                                    id="search-main"
                                    type="text"
                                ...
                                <button
                                    type="submit"
                                    className="inline-flex items-center px-3  text-sm text-white "
                                >
                    ...
                    <div className="flex gap-x-5 items-center ml-auto md:col-span-3 ">
                        ...
                        <Link href={route("shopping-cart.index")}>
                            <div className="group -m-2 flex items-center p-2">
                                ...
                                <span className="ml-2 text-sm font-medium  group-hover:">
